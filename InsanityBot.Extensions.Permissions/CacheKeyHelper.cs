...
internal static class CacheKeyHelper
{
    ...
    public static String GetRolePermissionKey(Int64 id) => $"InsanityBot.Extensions.Permissions.RolePermissions:{id}";

    public static String GetUserPermissionKey(Int64 id) => $"InsanityBot.Extensions.Permissions.UserPermissions:{id}";
