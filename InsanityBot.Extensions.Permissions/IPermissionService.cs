...
public interface IPermissionService
{
    ...
    public ValueTask<Boolean> CheckAnyPermission
    (
        DiscordUser user,
    ...
    public ValueTask<Boolean> CheckAllPermissions
    (
        DiscordUser user,
        IEnumerable<String> permissions
    );
    ...
    public ValueTask GrantPermissions
    (
        DiscordUser user,
        IEnumerable<String> permissions
    );
    ...
    public ValueTask RevokePermissions
    (
        DiscordUser user,
        IEnumerable<String> permissions
    );
